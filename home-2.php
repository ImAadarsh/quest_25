                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-none d-xxl-block">
                            <div class="header-button">
                                <a href="contact.php" class="th-btn style2 th-btn-icon">Request A Visit</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-xl-5">
                    ...
                    <div class="btn-wrap mt-5">
                        <a href="about.php" class="th-btn style2 th-btn-icon">More About Realar</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-xxl-6 col-lg-7">
                    <div class="title-area text-lg-start text-center">
                        ...
                        <p class="sec-text text-white">Realar help you easily create a real estate trading website. With the function Register, Login, Post real estate news.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                ...
                <div class="row justify-content-lg-between justify-content-center align-items-center">
                    <div class="col-xxl-6 col-lg-7">
                        <div class="title-area text-lg-start text-center">
                            ...
                            <p class="sec-text">Realar help you easily create a real estate trading website. With the function Register, Login, Post real estate news.</p>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="sec-btn">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="about-contact-grid">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text"><a href="mailto:infomailrealar@gmail.com">infomailrealar@gmail.com</a></p>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-end">
                <div class="col-xl-5 col-lg-6">
                    <div class="title-area text-lg-start text-center">
                        ...
                        <p class="text-white">Realar help you easily create a real estate trading website. With the function Register, Login, Post real estate news.</p>
                    </div>
                </div>
