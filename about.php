...
<head>
    ...
    <title>Eduace Quest 2025 - About</title>
            ...
            <div class="about-page-wrap">
                <div class="row gy-40 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-wrap2 style-theme mt-50">
                            <div class="checklist style4">
                                <ul>
                                    <li><img src="assets/img/icon/checkmark.svg" alt="img">STEAM Quiz for School Students</li>
                    ...
                    <div class="col-lg-6">
                        <div class="img-box3">
                            <div class="img1">
                                <img src="assets/img/about/c.png" alt="About">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-lg-between align-items-center">
                <div class="col-lg-6">
                    <div class="title-area">
                        <h2 class="sec-title text-white">Why Participate in the QUEST STEAM Quiz?</h2>
                        <p class="text-light">We offer a unique educational experience that delves into India's rich STEAM heritage. Our quiz is designed to engage students in a fascinating journey of discovery, exploring the achievements of Indian scientists, engineers, artists, and mathematicians.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                        <a href="contact.php" class="th-btn style-border th-btn-icon">Contact Us</a>
                    </div>
                </div>
            </div>
