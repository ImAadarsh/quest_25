                                ...
                                <ul>
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="index.php">Home Real Estate Agency</a></li>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner" data-mask-src="assets/img/hero/hero_1_bg_mask.png">
                        ...
                        <div class="hero-big-text">Quest</div>
                        <div class="container">
                    ...
                    <div class="col-xl-3 text-xl-end">
                        <div class="about-tag">
                            <div class="about-experience-tag">
                                <span class="circle-title-anime">Quest Agent <i class="fas fa-star"></i> Quest Living Solutions</span>
                            </div>
                    ...
                    <div class="col-xl-4">
                        <div class="project-title-wrap1">
                            <div class="title-area mb-40">
                                ...
                                <h2 class="sec-title text-white">Discover Modern Living At Quest Residence.</h2>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="title-area text-center">
                        ...
                        <h2 class="sec-title">Quest Aminities</h2>
                    ...
                    <div class="author-grid">
                        <div class="author-profile">
                            ...
                            <div class="media-body">
                                ...
                                <p class="author-desig">CEO of Quest</p>
                            </div>
                        </div>
