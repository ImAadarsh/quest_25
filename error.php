...
<head>
    ...
    <title>Eduace Quest 2025 - Error Page</title>
...
==============================-->
    <section class="error-area-1 position-relative">
        <div class="container">
            <div class="error-img">
                <img src="assets/img/normal/error_1_1.png" alt="404 image">
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="error-content">
                        ...
                        <a href="index.php" class="th-btn style-border2 th-btn-icon">Go Back Home</a>
                    </div>
                </div>
            </div>
        </div>
